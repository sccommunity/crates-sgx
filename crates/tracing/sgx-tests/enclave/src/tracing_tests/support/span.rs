...
pub struct MockSpan {
    pub(in crate::tracing_tests::support) metadata: metadata::Expect,
}

#[derive(Debug, Default, Eq, PartialEq)]
pub struct NewSpan {
    pub(in crate::tracing_tests::support) span: MockSpan,
    pub(in crate::tracing_tests::support) fields: field::Expect,
    pub(in crate::tracing_tests::support) parent: Option<Parent>,
}
...
impl MockSpan {
    ...
    pub(in crate::tracing_tests::support) fn check_metadata(&self, actual: &tracing::Metadata<'_>) {
