...
pub struct MockSpan {
    pub(in crate::futures_tests::supports) metadata: metadata::Expect,
}

#[derive(Debug, Default, Eq, PartialEq)]
pub struct NewSpan {
    pub(in crate::futures_tests::supports) span: MockSpan,
    pub(in crate::futures_tests::supports) fields: field::Expect,
    pub(in crate::futures_tests::supports) parent: Option<Parent>,
}
...
impl MockSpan {
    ...
    pub(in crate::futures_tests::supports) fn check_metadata(&self, actual: &tracing::Metadata<'_>) {
